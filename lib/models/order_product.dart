...
class OrderProduct {
  ...
  @override
  String toString() {
    return 'OrderProduct(id: $id, selectedProductId: $selectedProductId, title: $title, photo: $photo, price: $price, selectedColor: $selectedColor, selectedSize: $selectedSize, itemCount: $itemCount)';
  }
}
